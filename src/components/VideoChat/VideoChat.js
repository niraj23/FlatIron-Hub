...
<div id="home-container">
   ...
   <div id='nav-container'>
      <NavBar/>
      <h1 id='home-title' style={{textAlign: 'center', color: 'springgreen', marginTop: '55px', fontFamily: 'Trattatello, fantasy'}}>Video Chat</h1>
   </div>
   ...
   <div id='video-title-container'>
      <CopyToClipboard text={peerId}>
         <button className="submit" style={{width: '100%'}}>Copy User ID</button >
      </CopyToClipboard>
   </div>
   <div id='video3-container'>
      ...
      <button className="submit" onClick={() => call(remotePeerIdValue)}>Call</button >
   </div>
</div>
</>
  )
